...
import com.hr.onboard.config.ResetPasswordURL;
...
import com.hr.onboard.data.auth.*;
import com.hr.onboard.data.auth.request.*;
...
import com.hr.onboard.service.user.auth.LoginService;
import com.hr.onboard.service.user.auth.PasswordService;
import com.hr.onboard.service.user.auth.RegistrationService;
import com.hr.onboard.service.verification.VerificationService;
import com.hr.onboard.utils.AuthUtil;
import com.hr.onboard.utils.CookieUtils;
...
public class AuthController {
    ...
    public ResponseEntity webLogin(
            @Valid @org.springframework.web.bind.annotation.RequestBody LoginRequest request, HttpServletResponse response) {
        try {
            UserDetail userDetail = loginService.login(request.getUsername(), request.getPassword());
            TokenPair tokenPair = jwtService.issueTokens(userDetail);
    ...
    public ResponseEntity refresh(@Valid @org.springframework.web.bind.annotation.RequestBody RefreshRequest request) {
        try {
    ...
    public ResponseEntity introspect(@Valid @org.springframework.web.bind.annotation.RequestBody IntrospectionRequest request) {
        try {
    ...
    public ResponseEntity register(@Valid @org.springframework.web.bind.annotation.RequestBody RegisterRequest
                                               request) {
    ...
    public ResponseEntity issueVerificationCode(
            @Valid @org.springframework.web.bind.annotation.RequestBody IssueVerificationCodeRequest request) {
    ...
    public ResponseEntity changePassword(@Valid @org.springframework.web.bind.annotation.RequestBody ChangePasswordRequest request) {
        try {
    ...
    public ResponseEntity forgetPassword(@Valid @org.springframework.web.bind.annotation.RequestBody ForgetPasswordRequest request) {
        try {
    ...
    public ResponseEntity resetPassword(@Valid @org.springframework.web.bind.annotation.RequestBody ResetPasswordRequest request) {
        try {
