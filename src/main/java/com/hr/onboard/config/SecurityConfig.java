...
import com.hr.onboard.filter.JwtAuthenticationFilter;
import com.hr.onboard.service.user.UserDetailService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        return http.cors(Customizer.withDefaults())
                ...
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.NEVER)) // use jwt instead of session
